...
input.setAttribute('style', 'width:60px;font-size:16px;z-index:1;position:fixed;bottom:10px;left:0px; ');
...
input1.setAttribute('style', 'width:70px;font-size:16px;z-index:1;position:fixed;bottom:10px;left:60px; ');
...
input2.setAttribute('style', 'width:60px;font-size:16px;z-index:1;position:fixed;bottom:10px;left:130px; ');
